...
- **[Trapped-ion control stack](https://github.com/Yueh-H/trapped-ion-control-stack)** — A clean-room Python reference for compilation, scans, calibration, simulation, hardware admission, and traceable results. The public source is a scanned fresh-history release; it makes no physical-ion or fidelity claim.
...
- **[Engineer Blackboard](https://github.com/Yueh-H/engineers-blackboard-site)** — A TypeScript/React learning site with repeatable builds, rendered-output tests, and GitHub Pages deployment.
